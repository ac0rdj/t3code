...
/**
 * The DeepSeek mark, from the official DeepSeek logo.
 * The source artwork spans roughly 0-56 x 0-41, so the viewBox is cropped to the mark.
 */
export const DeepSeekIcon: Icon = ({ className, ...props }) => (
  <svg {...props} viewBox="0 0 56.2 41.4" fill="none" className={cn("fill-[#4D6BFE]", className)}>
